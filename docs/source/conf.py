...
# -*- coding: utf-8 -*-
#
# rdlEngine documentation build configuration file, created by
...
# ones.
import hawkmoth
extensions = ["hawkmoth","sphinx_rtd_theme"]
...
htmlhelp_basename = 'rdlEnginedoc'
...
man_pages = [
    (master_doc, 'rdlengine', 'rdlEngine Documentation',
     [author], 1)
]
